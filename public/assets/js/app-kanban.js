                    ...
                    o
                        ...
                        .insertAdjacentHTML(
                            ...
                            p(
                                ...
                                "<div class='avatar avatar-xs ms-1'><span class='avatar-initial rounded-circle bg-label-secondary'><i class='bx bx-plus'></i></span></div>"
                        );
            },
            ...
            null !== e.getAttribute("data-image") &&
                ...
                (void 0 === e.getAttribute("data-comments") &&
                    ...
                    e.insertAdjacentHTML(
                        ...
                        "<div class='d-flex justify-content-between align-items-center flex-wrap mt-2 pt-1'><div class='d-flex'> <span class='d-flex align-items-center me-2'><i class='bx bx-paperclip me-1'></i><span class='attachments'>" +
                            t +
                            "</span></span> <span class='d-flex align-items-center ms-1'><i class='bx bx-chat me-1'></i><span> " +
                            a +
    ...
    c &&
        ...
        o &&
            o.addEventListener("shown.bs.offcanvas", function () {
                [].slice
                    .call(o.querySelectorAll('[data-bs-toggle="tooltip"]'))
                    .map(function (e) {
                        return new bootstrap.Tooltip(e);
                    });
            });
