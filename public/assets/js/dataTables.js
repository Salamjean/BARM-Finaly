...
(function (factory) {
    ...
    function _fnMacros(settings, str, entries) {
        ...
        return str
            ...
            .replace(/_ENTRIES_/g, settings.api.i18n("entrées", "", entries))
            .replace(/_ENTRIES-MAX_/g, settings.api.i18n("entrées", "", max))
            .replace(/_ENTRIES-TOTAL_/g, settings.api.i18n("entrées", "", vis));
    }
    ...
    DataTable.defaults = {
         ...
         * the page number, so if you have 10 records par page and want to start on
        ...
        oLanguage: {
             ...
             */
            sInfo: "Affichage _START_ à _END_ sur _TOTAL_ _ENTRIES-TOTAL_",

            /**
             * Display information string for when the table is empty. Typically the
             * format of this string should match `info`.
             */
            sInfoEmpty: "Affichage 0 à 0 sur 0 _ENTRIES-TOTAL_",
             ...
             */
            sInfoFiltered: "(filtré sur _MAX_ total _ENTRIES-MAX_)",
