...
commentEditor &&
    new Quill(commentEditor, {
        ...
        placeholder: "Entrez la discription...",
        theme: "snow",
    }),
    $(function () {
        let e, t, a;
                ...
                ((o = s.DataTable({
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            render: function (e, t, a, o) {
                                return (
                                    "<div class='fw-medium text-sm-end'>" +
                                    a.total_earnings +
                                    "</div"
                                );
                            },
                    ...
                    order: [2, "desc"],
                    dom: '<"card-header d-flex flex-wrap"<f><"d-flex justify-content-center justify-content-md-end align-items-baseline"<"dt-action-buttons d-flex justify-content-center flex-md-row mb-3 mb-md-0 ps-1 ms-1 align-items-baseline gap-2"lB>>>t<"row mx-2"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
