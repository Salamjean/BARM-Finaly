...
!(function () {
    ...
    if (null !== t) {
        var o = t.querySelector("#wizard-property-listing-form"),
            e = o.querySelector("#etat-civil"),
            i = o.querySelector("#situation-matrimoniale"),
            a = o.querySelector("#situation-professionnelle"),
            n = o.querySelector("#projet-professionnel"),
            r = o.querySelector("#condition-depart"),
