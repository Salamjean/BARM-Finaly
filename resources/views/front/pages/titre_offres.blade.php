...
<script>
   ...
   $(document).ready(function() {
            $('#titleSelect').on('change', function() {
                ...
                if (title) {
                    $.ajax({
                        url: '/titles/offres' + title,
                        type: 'GET',
                        success: function(response) {
                            $('#content').html('Contenu pour le titre: ' + response.content);
                        },
                        error: function(jqXHR, textStatus, errorThrown) {
                            console.error(textStatus, errorThrown);
                            $('#content').html('Erreur lors de la récupération du contenu.');
                        }
                    });
                } else {
                    $('#content').html('Aucun titre sélectionné.');
                }
            });
        });
