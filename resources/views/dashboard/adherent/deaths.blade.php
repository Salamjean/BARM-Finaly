    ...
    <div class="container-fluid">
        ...
        <div class="bg-white p-4 rounded-3 shadow-none mb-4">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <i class="bx bx-filter text-info fs-3 me-3"></i>
                    <div>
                        <h5 class="mb-0 text-dark">{{ $title }}</h5>
                        <small class="text-muted">Liste filtrée des candidatures</small>
                    </div>
                </div>
                <div class="d-flex align-items-center gap-3">
                    <a href="{{ route('export.pdf.deaths') }}" class="btn btn-danger btn-sm text-white shadow-sm">
