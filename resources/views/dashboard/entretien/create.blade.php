    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <p class="text-muted mb-0 small">Entreprise Privée &bull; Planification et affectation des candidats</p>
            </div>
        </div>
        <div>
        ...
        <div class="col-xl-11 col-lg-12">
            <div class="card card-entretien bg-white mb-4">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('entretiens.store') }}" enctype="multipart/form-data" id="formOrganizeEntretien">
                        @csrf
                        <input type="hidden" name="parcours" value="entreprise_privee" />
                        <!-- Conteneur des inputs cachés pour les candidats sélectionnés -->
