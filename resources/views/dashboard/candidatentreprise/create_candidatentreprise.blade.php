        ...
        <div class="col-xl-10 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    <form class="row g-3" method="POST" action="{{ route('candidatentreprises.store_candidature_spontannee') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Candidat(s) :</label>
                            <input class="form-control" type="text" value="{{ $candidat->user->lastname }} {{
                                    $candidat->user->firstname }}" disabled>
                            <input class="form-control" type="text" name="candidature_id" value="{{$candidat->id}}" hidden>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input class="form-control @error('date_mise_disposition') is-invalid @enderror" type="file" name="lettre_recommandation">
                        </div>
                        <div class="col-md-6 mb-3">
