                                        ...
                                        <div class="modal-content border-0 shadow">
                                            ...
                                            <div class="modal-body p-4">
                                                <div class="text-center mb-3">
                                                    <p class="text-muted mb-1 small">Parcours initial : <strong>Fonction Publique</strong></p>
                                                ...
                                                <form action="{{ route('adherent.decision.profilage', $candidat->id) }}" method="POST" class="mb-3">
                                                    ...
                                                    <button type="submit" class="btn btn-success w-100 py-2 fw-semibold shadow-sm">
                                                        <i class="bx bx-check-circle me-1 fs-5 align-middle"></i> Confirmer en Fonction Publique
                                                    </button>
                                                </form>
