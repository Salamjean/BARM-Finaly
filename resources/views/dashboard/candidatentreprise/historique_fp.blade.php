            ...
            <div class="border-start border-primary border-3 ps-3">
                <nav aria-label="breadcrumb">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <div class="text-muted small">Profilage &bull; Fonction Publique</div>
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-body p-3 d-flex align-items-center">
                        ...
                        <div>
                            <span class="text-muted small">Confirmés FP</span>
                            <h4 class="mb-0 fw-bold text-warning">
                                {{ $candidats->where('orientation', 'fonction-publique')->count() }}
                            </h4>
                        </div>
                    </div>
                </div>
                                                                ...
                                                                <div class="card border shadow-none">
                                                                    ...
                                                                    <div class="card-body py-3 small">
                                                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                                                            ...
                                                                            <div>
                                                                                @if ($candidat->orientation === 'fonction-publique')
                                                                                    <span class="badge bg-info fs-6 px-3 py-2">Confirmé en Fonction Publique</span>
                                                                                @elseif ($candidat->orientation === 'auto-emploi')
                                                                                    <span class="badge bg-warning text-dark fs-6 px-3 py-2">Réorienté vers Auto-Emploi</span>
                                                                                @elseif ($candidat->orientation === 'entreprise-privee')
                                                                                    <span class="badge bg-success fs-6 px-3 py-2">Réorienté vers Entreprise Privée</span>
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                                    </div>
