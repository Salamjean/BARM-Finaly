...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="bg-white p-4 rounded-3 shadow-none mb-4">
            <div class="d-flex align-items-center">
                <i class="bx bx-edit text-info fs-3 me-3"></i>
                <div>
                    <h5 class="mb-0 text-dark">Modification de l'entreprise</h5>
                    <small class="text-muted">Mise à jour des informations de {{ $entreprise->nom }}</small>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-10 mx-auto">
                <div class="bg-white rounded-3 shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3" method="POST" action="{{route('entreprises.update',$entreprise->id)}}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('specialisation') is-invalid @enderror"
                                        id="specialisation" name="specialisation" value="{{$entreprise->specialisation}}"
                                        />
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('localisation') is-invalid @enderror"
                                        id="localisation" name="localisation" value="{{ $entreprise->localisation }}"
                                        />
                                </div>
                                @error('localisation')
                                <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('num_decharge') is-invalid @enderror"
                                        id="num_decharge" name="num_decharge" value="{{ $entreprise->num_decharge }}"
                                        />
                                </div>
                                @error('num_decharge')
                                <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('nom_point_focal') is-invalid @enderror"
                                        ...
                                        value="{{ $entreprise->nom_point_focal }}" />
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('num_point_focal') is-invalid @enderror"
                                        ...
                                        value="{{ $entreprise->num_point_focal }}" />
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="email"
                                        ...
                                        value="{{ $entreprise->email_point_focal }}" />
                                </div>
