        ...
        <div class="bg-white p-4 rounded-3 shadow-none mb-4">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-0 text-dark">Détails de l'entreprise</h5>
                        <small class="text-muted">Informations complètes de {{ $entreprise->nom }}</small>
                    </div>
                </div>
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3" method="POST" action="{{ route('entreprises.store') }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('nom') is-invalid @enderror" id="nom"
                                        name="nom" value="{{$entreprise->nom}}" disabled />
                                </div>
                                @error('nom')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('specialisation') is-invalid @enderror"
                                        id="specialisation" name="specialisation" value="{{$entreprise->specialisation}}" disabled />
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('localisation') is-invalid @enderror"
                                        id="localisation" name="localisation" value="{{ $entreprise->localisation }}" disabled />
                                </div>
                                @error('localisation')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('num_decharge') is-invalid @enderror"
                                        id="num_decharge" name="num_decharge" value="{{ $entreprise->num_decharge }}" disabled />
                                </div>
                                @error('num_decharge')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('nom_point_focal') is-invalid @enderror"
                                        id="nom_point_focal" name="nom_point_focal" value="{{ $entreprise->nom_point_focal }}" disabled />
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('num_point_focal') is-invalid @enderror"
                                        id="num_point_focal" name="num_point_focal" value="{{ $entreprise->num_point_focal }}" disabled/>
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="email"
                                        class="form-control @error('email_point_focal') is-invalid @enderror"
                                        id="email_point_focal" name="email_point_focal" value="{{ $entreprise->email_point_focal }}" disabled />
                                </div>
