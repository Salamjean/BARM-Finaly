                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex align-items-center gap-2 mb-2">
                                                <span class="badge bg-success">{{ $cohort->adherents_account_opening_approved }}</span>
                                                <span class="text-muted small">terminés</span>
                                                <span class="badge bg-warning">{{ $cohort->adherents_account_opening_pending }}</span>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            <a href="{{ route('monitored-evaluation.account_opening.cohort.plug_removal', $cohort->id) }}" 
