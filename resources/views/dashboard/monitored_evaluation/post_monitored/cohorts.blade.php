        ...
        <div class="bg-white p-4 rounded-3 shadow-none mb-4">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-0 text-dark">Suivi post-formation</h5>
                        <small class="text-muted">Évaluation des projets après formation</small>
                    </div>
                </div>
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="text-center">
                        <div class="badge bg-success fs-6 px-3 py-2">
                            {{ $cohorts->sum('candidature_post_monitored_count') }}
                        </div>
                        <small class="text-muted d-block">Suivis</small>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <table class="dt-responsive table table-hover" id="datatable--barm" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($cohorts as $cohort)
                                @php
                                    $totalAdherents = $cohort->adhrents->count();
                                    $suivis = $cohort->candidature_post_monitored_count;
                                    $percentage = $totalAdherents > 0 ? round(($suivis / $totalAdherents) * 100) : 0;
                                    ...
                                    <td>
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex align-items-center gap-2 mb-2">
                                                <span class="badge bg-success">{{ $cohort->candidature_post_monitored_count }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            <a href="{{ route('monitored-evaluation.post_monitored.cohort', $cohort->id) }}" 
