    ...
    <div class="container-fluid">
            ...
            <div class="border-start border-primary border-3 ps-3">
                <nav aria-label="breadcrumb">
                    <div class="d-flex align-items-center">
                        <i class="bx bx-like text-primary fs-4 me-3"></i>
                        <div>
                            <div class="text-muted small">Suivi-Évaluation / Avis favorable / Cohorte</div>
        ...
        <div class="bg-white p-4 rounded-3 shadow-none mb-4">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <i class="bx bx-medal text-success fs-3 me-3"></i>
                    <div>
                        <h5 class="mb-0 text-dark">Avis favorables</h5>
                        <small class="text-muted">Validation finale des projets approuvés</small>
                    </div>
                </div>
                                        ...
                                        @if ($adherent->phone_number)
                                            <div class="mb-3">
                                                ...
                                                <div class="fw-medium">
                                                    ...
                                                    @if ($adherent->phone_number2)
                                                        , {{ $adherent->phone_number2 }}
                                                    @endif
                                                    @if ($adherent->phone_number3)
                                                        , {{ $adherent->phone_number3 }}
                                                    @endif
                                                </div>
                                            </div>
                                        @endif
                                            ...
                                            <div class="mb-3 p-2 border border-info rounded">
                                                ...
                                                @if (!$adherent->other_partner_financial)
                                                    <div class="small mb-2">
                                                        ...
                                                        {{ dateFr($adherent->paAccepted->commission->date) }}
                                                    </div>
                                                @endif
                                                <div class="small mb-2">
                                                ...
                                                @if (!$adherent->other_partner_financial)
                                                    <div class="small">
                                                        <strong>Crédit souhaité :</strong>
                                                        {{ amount($adherent->paAccepted->credit) }} {{ DEVICE }}
                                                    </div>
                                                @endif
                                            </div>
                                        @endif
                                        ...
                                        @if (can('chef-celulle-suivi-evaluation|responsable-suivi-evaluation'))
                                            <div class="border-top pt-3">
                                                <form class="formSubmit"
                                                    action="{{ route('monitored-evaluation.favorable_opinion.approved', $adherent->id) }}"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="file{{ $key }}" class="form-label small">
                                                            ...
                                                            Fiche d'avis favorable <span class="text-danger">*</span>
                                                        </label>
                                                        <input type="file" class="form-control form-control-sm"
                                                            name="file" accept=".pdf" required />
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="amount{{ $key }}" class="form-label small">
                                                            <i class="bx bx-money text-primary me-1"></i>
                                                            Crédit accordé <span class="text-danger">*</span>
                                                        </label>
                                                        <div class="input-group input-group-sm">
                                                            <input type="number"
                                                                value="{{ $adherent->paAccepted->credit }}"
                                            ...
                                            <td>
                                                <div class="border-start border-info border-3 ps-2 py-1">
                                                    <div class="fw-medium text-info">
                                                        {{ $adherent->choiceFinal->specialisation }}</div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.formSubmit').submit(function(e) {
                    ...
                    Swal.fire({
                        title: 'Êtes-vous sûr d\'approuver l\'avis favorable?',
                        icon: 'warning',
                        iconColor: '#E68200',
