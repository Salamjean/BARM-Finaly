            ...
            <div class="border-start border-primary border-3 ps-3">
                <nav aria-label="breadcrumb">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <div class="text-muted small">Suivi-Évaluation / Décaissement</div>
        ...
        <div class="bg-white p-4 rounded-3 shadow-none mb-4">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-0 text-dark">Suivi des décaissements</h5>
                        <small class="text-muted">Gestion des versements par cohorte</small>
                    </div>
                </div>
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="text-center">
                        <div class="badge bg-warning fs-6 px-3 py-2">
                            {{ $cohorts->sum('candidature_pending_count') }}
                        </div>
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex align-items-center gap-2 mb-2">
                                                ...
                                                <span class="badge bg-warning">{{  $cohort->candidature_pending_count }}</span>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            <a href="{{ route('monitored-evaluation.disbursement.cohort', $cohort->id) }}" 
