                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('mecano') is-invalid @enderror" id="mecano" name="mecano"
                                    placeholder="CS-000000/00" value="{{ old('mecano') }}" required>
                                @error('mecano')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                    name="email" placeholder="adherent@gmail.com" value="{{ old('email') }}">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('type_piece') is-invalid @enderror"
                                    ...
                                    @foreach (TYPEPIECES as $type_piece)
                                        <option value="{{ $type_piece }}" {{ old('type_piece') == $type_piece ? 'selected' : '' }}>{{ $type_piece }}</option>
                                    @endforeach
                                </select>
                                @error('type_piece')
                                    <span class="invalid-feedback" role="alert">
