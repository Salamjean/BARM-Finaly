    ...
    <div class="container-fluid">
        ...
        <div class="bg-white p-4 rounded-3 shadow-none mb-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-0 text-dark">Nouvelle séance de préparation</h5>
                    <small class="text-muted">Création d'une séance de préparation à l'entretien pour {{ $candidat->user->fullName() }}</small>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-10 mx-auto">
                <div class="bg-white rounded-3 shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3" method="POST" action="{{ route('prepaentretiens.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="commentaire" class="form-control" id="" cols="10" rows="5" 
                                          placeholder="Notes sur la séance de préparation..."></textarea>
                            </div>
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3 float-end">
                                    ...
                                    <a href="{{ route('prepaentretiens.index', $candidat->id) }}" type="reset"
