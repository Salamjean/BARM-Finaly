    ...
    <div class="row">
        <div class="col-xl-12 mx-auto">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">Personnels/</span> Créer un Personnel Civil
            </h4>
            <div class="card">
                <div class="card-header px-4 py-3 border-bottom">
                    <h5 class="mb-0">Créer un Personnel Civil</h5>
                </div>
                        ...
                        <div class="bs-stepper wizard-numbered mt-2">
                            <div class="col-xxl-8 col-md-8 mx-auto">
                                <div class="bs-stepper-header">
                                    <div class="step" data-target="#niveau1">
                                    ...
                                    <div class="line"></div>
                                    <div class="step" data-target="#niveau2">
                                        <button type="button" class="step-trigger">
                                    ...
                                    <div class="line"></div>
                                    <div class="step" data-target="#niveau3">
                                        <button type="button" class="step-trigger">
                                            <span class="bs-stepper-circle">3</span>
                                            <span class="bs-stepper-label">
                                                <span class="bs-stepper-title">Autres</span>
                                            </span>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="bs-stepper-content">
                                <form id="formCivil" class="row g-3" method="POST" action="{{ route('personnel.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <!-- Account Details -->
                                    <div id="niveau1" class="content">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-8 form-group">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                                                    <input type="text" class="form-control border-start-0" id="firstname"
                                                        placeholder="Prénom(s)" name="firstname" value="{{ old('firstname') }}" />
                                                </div>
                                                @error('firstname')
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                                                    <input type="text" class="form-control border-start-0" id="lastname" placeholder="Nom"
                                            ...
                                            <div class="col-md-3">
                                                <label for="lieu_naissance form-group" class="form-label">Lieu de naissance </label>
                                                <div class="input-group"> <span class="input-group-text"><i
                                                            class="fa-solid fa-street-view"></i></span>
                                                    <input type="text" class="form-control border-start-0" id="lieu_naissance"
                                            ...
                                            <div class="col-md-3 form-group">
                                                ...
                                                <select class="form-select @error('gender') is-invalid @enderror"
                                                    ...
                                                    <option value="masculin" {{ old('gender')=='masculin' ? 'selected' : '' }}>Masculin
                                                    </option>
                                            ...
                                            <div class="col-md-3 form-group">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                    ...
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('nationalite') is-invalid @enderror"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                    ...
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('no_card') is-invalid @enderror"
                                            ...
                                            <div class="col-md-3">
                                                <label for="lieu_etabli" class="form-label">Lieu d'étalissement</label>
                                                <div class="input-group"> <span class="input-group-text"><i
                                                            class="fa-solid fa-map-location-dot"></i></span>
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('lieu_etabli') is-invalid @enderror"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="date" class="form-control @error('date_validite') is-invalid @enderror"
                                                    id="date_validite" name="date_validite" value="{{ old('date_validite') }}">
                                                @error('date_validite')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                    ...
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('no_cim') is-invalid @enderror"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i class='bx bxs-phone'></i></span>
                                                    <input type="text" class="form-control border-start-0" id="phone"
                                                        placeholder="N° de telephone" name="phone" value="{{ old('phone') }}" />
                                                </div>
                                                @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-12 d-flex justify-content-between">
                                                ...
                                                <button class="btn btn-primary"> <span
                                                        class="d-sm-inline-block d-none">Suivant</span> <i
                                                        class="bx bx-chevron-right bx-sm me-sm-n2"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Personal Info -->
                                    <div id="niveau2" class="content">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                    ...
                                                    <input type="text" class="form-control border-start-0" id="grade" placeholder="Grade"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                    ...
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('matricule_barm') is-invalid @enderror"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                    ...
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('matricule') is-invalid @enderror"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                    ...
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('mecano') is-invalid @enderror"
                                                        id="mecano" name="mecano" value="{{ old('mecano') }}" placeholder="N° Mécano">
                                                </div>
                                                @error('mecano')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                            class="fa-brands fa-pied-piper"></i></span>
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('cellule') is-invalid @enderror"
                                                        id="cellule" name="cellule" value="{{ old('cellule') }}" placeholder="Cellule">
                                                </div>
                                                @error('cellule')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                    ...
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('fonction') is-invalid @enderror"
                                                        id="fonction" name="fonction" value="{{ old('fonction') }}" placeholder="Fonction"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                    ...
                                                    <input type="date"
                                                        class="form-control border-start-0 @error('date_prise_service') is-invalid @enderror"
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <select class="form-select select2" data-placeholder="Choisir le service d'affectation"
                                                    id="small-bootstrap-class-multiple-field" multiple name="roles[]">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                    ...
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('diplome_militaire') is-invalid @enderror"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                            class="fa-solid fa-business-time"></i></span>
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('diplome_eleve') is-invalid @enderror"
                                                        id="diplome_eleve" name="diplome_eleve" value="{{ old('diplome_eleve') }}"
                                                        placeholder="Diplôme civil le plus élévé">
                                                </div>
                                                @error('diplome_eleve')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                    ...
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('lieu_formation') is-invalid @enderror"
                                                        id="lieu_formation" name="lieu_formation" value="{{ old('lieu_formation') }}"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                    ...
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('annee_formation') is-invalid @enderror"
                                                        id="annee_formation" name="annee_formation" value="{{ old('annee_formation') }}"
                                    ...
                                    <!-- Social Links -->
                                    <div id="niveau3" class="content">

                                        <div class="row g-3">
                                            <div class="col-md-4">
                                                <label for="nbre_enfant" class="form-label">Nombre d'enfant</label>
                                                <div class="input-group"> <span class="input-group-text"><i
                                                            class="fa-solid fa-children"></i></span>
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('nbre_enfant') is-invalid @enderror"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                            class="fa-solid fa-truck-droplet"></i></span>
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('group_sanguin') is-invalid @enderror"
                                                        id="group_sanguin" name="group_sanguin" value="{{ old('group_sanguin') }}"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group"> <span class="input-group-text"><i
                                                    ...
                                                    <input type="text"
                                                        class="form-control border-start-0 @error('lieu_residence') is-invalid @enderror"
                                            ...
                                            <div class="col-md-12 mb-10">
                                                <label for="nom_telephone_cas_urgence" class="form-label">Nom et numero téléphonique de la
                                                    personne a contacter en cas d'urgence</label>
                                                <input type="text"
                                                    class="form-control @error('nom_telephone_cas_urgence') is-invalid @enderror"
                                                    id="nom_telephone_cas_urgence" name="nom_telephone_cas_urgence"
                                                    value="{{ old('nom_telephone_cas_urgence') }}"
                                                    placeholder="Nom et numero téléphonique de la personne a contacter en cas d'urgence">
