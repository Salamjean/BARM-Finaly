        ...
        <div class="row">
            <div class="col-xl-12 mx-auto">
                <h4 class="py-3 breadcrumb-wrapper mb-4">
                    <span class="text-muted fw-light">Identification ></span> Personnel Civil
                </h4>
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3" method="POST" action="{{ route('personalbarm.store') }}"
                            ...
                            <div class="row mt-2">
                                <div class="col-md-3">
                                    ...
                                    <input type="date" class="form-control @error('birth_date') is-invalid @enderror"
                                        id="birth_date" name="birth_date" max="{{ Carbon\Carbon::now()->subYears(20)->format('Y-m-d') }}" value="{{ old('birth_date') }}">
                                    @error('birth_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select class="form-select select2"
                                        data-placeholder="Choisir le service d'affectation" id="group_sanguin"
                                        name="group_sanguin" required>
                                        <option selected disabled>Selectionner</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="matricule_fae" name="matricule_fae" value="{{ old('matricule_fae') }}"
                            ...
                            <div class="row mt-2">
                                <div class="col-md-3">
                                    <label for="    " class="form-label">Diplôme civil (plus élévé)</label>

                                    <select class="form-select select2" id="    " name="   ">
                                        <option selected disabled>Selectionner</option>
                                        @foreach (EDUCATIONS as $education)
                                            <option value="{{ $education }}" {{ old('   ') ? 'selected' : '' }}>{{ $education }}</option>
                                        @endforeach
                                    </select>
                                    @error('    ')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('derniere_formation') }}" placeholder="Dernière formation">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select @error('statut_personnel') is-invalid @enderror"
                                        ...
                                        <option value="" disabled
                                            {{ old('statut_personnel') == '' ? 'selected' : '' }}>Sélectionner</option>
                                        <option value="Contractuel"
                                            {{ old('statut_personnel') == 'Contractuel' ? 'selected' : '' }}>Contractuel
                                        </option>
                                        <option value="Fonctionnaire civil"
                                            {{ old('statut_personnel') == 'Fonctionnaire civil' ? 'selected' : '' }}>
                                            Fonctionnaire civil</option>
                                    </select>
                            ...
                            <div class="col-md-12">
                                <br><br>
                                <button type="button"
                                    class="btn btn-outline-primary add_decoration_btn fs-4 mt-10 mb-10"><i class="fa-solid fa-plus-circle">&nbsp;</i>
