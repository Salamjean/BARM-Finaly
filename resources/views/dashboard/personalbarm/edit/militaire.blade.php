                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-4">
                                    <form class="row g-3" method="POST"
                                        action="{{ route('personnel.update', $personal->id) }}"
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="lieu_etabli" name="lieu_etabli"
                                                    placeholder="Lieu d'étbalissement"
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('no_cim') is-invalid @enderror"
                                                    id="no_cim" name="no_cim"
                                                    value="{{ old('no_cim') ?? $personal->no_cim }}"
                                                    placeholder="N° CIM">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select class="form-select select2" id="group_sanguin"
                                                    name="group_sanguin" required>
                                                    <option selected disabled>Selectionner</option>
                                                    @foreach (BLOODGROUPS as $blood)
                                                        <option value="{{ $blood }}"
                                                            {{ $personal->groupe_sanguin == $blood ? 'selected' : '' }}>
                                                            {{ $blood }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('mecano') is-invalid @enderror"
                                                    id="mecano" name="mecano"
                                                    value="{{ old('mecano') ?? $personal->mecano }}"
                                            ...
                                            <div class="col-md-3">
                                                <label for="diplome_militaire" class="form-label">Diplôme
                                                    militaire</label>

                                                <input type="text"
                                                    class="form-control @error('diplome_militaire') is-invalid @enderror"
                                                    id="diplome_militaire" name="diplome_militaire"
                                                    value="{{ old('diplome_militaire') ?? $personal->diplome_militaire }}"
                                                    placeholder="Diplôme militaire">
                                            ...
                                            <div class="col-md-3">
                                                <label for="diplome_eleve" class="form-label">Diplôme civil (plus
                                                    élévé)</label>

                                                <select class="form-select select2" id="diplome_eleve"
                                                    name="diplome_eleve">
                                                    <option selected disabled>Selectionner</option>
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select
                                                    class="form-select @error('statut_personnel') is-invalid @enderror"
                                                    aria-label="Default select example" name="statut_personnel">

                                                    <option value="Fonctionnaire militaire"
                                                        {{ old('statut_personnel') ?? $personal->statut_personnel == 'Fonctionnaire militaire' ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-3">
                                                <label for="telephone_cas_urgence" class="form-label">Contact(cas
                                                    urgent)</label>
