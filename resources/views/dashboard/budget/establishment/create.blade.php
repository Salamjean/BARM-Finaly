            ...
            <div class="col-xl-10 mx-auto">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3" method="POST" action="{{ route('annual-budget.establishment.store') }}"
                            enctype="multipart/form-data">
                            @csrf
                                <input type="hidden" name="http" class="form-control" value="post">

                            <div class="col-md-6 mb-10">
                                <label for="libelle" class="form-label">Titre: </label>
                                <input type="text" class="form-control" value="{{ $budget->title }} " disabled>
                            </div>
                            <div class="col-md-5 mb-10">
                                <label for="" class="form-label">Cellule: </label>
                                <input type="text" class="form-control" disabled
                                    value="{{ (controllerPersonal())->role->name }}">
                            </div>
                            <div class="col-md-1 mb-10">
                                <label for="" class="form-label">Année: </label>
                                <input type="text" class="form-control" disabled value="{{ $budget->year }}">
                            </div>
