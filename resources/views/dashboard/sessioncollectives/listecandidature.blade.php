                        ...
                        <tbody>
                            @foreach ($candidatures as $index => $candidat)
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        @if ($candidat->choiceFinal)
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <div class="fw-medium">
                                                        {{ dateFr($candidat->choiceFinal->profilage_date) }}</div>
                                                    <small
                                                        class="text-muted">{{ dateFr($candidat->choiceFinal->profilage_date, 'complet') }}</small>
                                                </div>
                                            </div>
                                        @endif
                                    ...
                                    <td>
                                        <div class="border-start border-primary border-3 ps-2 py-1">
                                            <div class="d-flex align-items-center">
                                                <span
                                                    class="badge bg-primary">{{ $candidat->partnerTechnical->user->username }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        @if ($candidat->partnerFinancial)

                                        <div class="border-start border-warning border-3 ps-2 py-1">
                                            <div class="d-flex align-items-center">
                                                <span
                                                    class="badge bg-warning">{{ $candidat->partnerFinancial->user->username }}</span>
                                            </div>
                                        </div>
