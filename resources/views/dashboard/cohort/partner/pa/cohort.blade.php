                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="text-center">
                        <div class="badge bg-success fs-6 px-3 py-2">
                            {{ amount($adherents->sum(function($adherent) { return $adherent->paAccepted->credit ?? $adherent->paAccepted->amount ?? 0; }), true) }}
                        </div>
                        <div class="small text-muted">Montant total des projets</div>
                    </div>
                </div>
            </div>
        </div>
