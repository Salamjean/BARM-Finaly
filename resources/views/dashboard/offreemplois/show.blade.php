                    ...
                    <form class="row g-3" method="POST" action="{{ route('offreemplois.store') }}"
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" readonly class="form-control" id="libelle" placeholder="Intitule" name="libelle"
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="" cols="30" rows="10" readonly>{{ $offreemploi->description }}</textarea>
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group"> <span class="input-group-text"><i class='bx bxs-map'></i></span>
                                <input type="text" readonly class="form-control border-start-0" id="lieu" placeholder="Lieu" name="localisation"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group"> <span class="input-group-text"><i class='bx bx-date'></i></span>
                                <input type="text" readonly class="form-control @error('datefin') is-invalid @enderror" id="datefin"
                                    placeholder="Date" name="datefin" value="{{ dateFr($offreemploi->datefin, 'letter')}}" />
                            </div>
                            @error('datefin')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
