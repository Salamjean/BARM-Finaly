            ...
            <div class="border-start border-primary border-3 ps-3">
                <nav aria-label="breadcrumb">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <div class="text-muted small">Commissions d'approbation</div>
        ...
        <div class="bg-white p-4 rounded-3 shadow-none mb-4">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-0 text-dark">Commissions d'approbation</h5>
                                ...
                                <tr class="align-middle">
                                    <td>
                                        <div class="border-start border-info border-3 ps-2 py-1">
                                            <div class="fw-bold text-info">{{ $commission->cohort->reference }}</div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="border-start border-info border-3 ps-2 py-1">
