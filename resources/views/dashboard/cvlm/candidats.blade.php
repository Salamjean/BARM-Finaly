    ...
    <div class="container-fluid">
            ...
            <div class="border-start border-primary border-3 ps-3">
                <nav aria-label="breadcrumb">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <div class="text-muted small">Documents professionnels</div>
                            <h4 class="mb-0 text-primary">CV et Lettres de Motivation</h4>
                        </div>
                    </div>
                </nav>
            </div>
        ...
        <div class="bg-white p-4 rounded-3 shadow-none mb-4">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <i class="bx bx-folder-open text-info fs-3 me-3"></i>
                    <div>
                        <h5 class="mb-0 text-dark">Gestion des CV et lettres de motivation</h5>
                        <small class="text-muted">Suivi des documents professionnels par candidat</small>
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach ($candidats as $candidat)
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            $docCount = $candidat->cvlms->count();
                                            $badgeClass = $docCount > 0 ? 'bg-success' : 'bg-secondary';
                                        @endphp
                                        <span class="badge {{ $badgeClass }} fs-6">{{ $docCount }}</span>
                                        @if ($docCount > 0)
                                        ...
                                        @else
                                            <small class="text-muted d-block">Aucun document</small>
                                        @endif
                                    </td>
                                    <td style="">
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a class="btn btn-primary btn-sm"
                                                href="{{ route('cvlms.index', $candidat->id) }}" title="Voir les documents">
