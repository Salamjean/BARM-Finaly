...
@section('content')
    @push('css-push')
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/budget-app.css') }}">
        <style>
            :root {
    ...
    <div class="budget-header">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-chart-line me-3"></i>Suivi de Plans Budgétaires</h1>
                    <p class="mb-0 opacity-75 mt-2">Consultez et exportez vos plans budgétaires pour le suivi</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="budget-table-container">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="{{ route('budget-plans.monitoring.show', $plan) }}" class="btn btn-action btn-view">
                                            <i class="fas fa-eye"></i>
                                            <span class="d-none d-md-inline">Voir</span>
                                        </a>
                                        @if(can('responsable-suivi-evaluation|assistant-suivi-evaluation'))
                                        <a href="{{ route('budget-plans.monitoring.export', $plan) }}" class="btn btn-action btn-export">
            ...
            @else
                <div class="empty-state">
                    ...
                    <h3>Aucun plan budgétaire à suivre</h3>
                    <p>Les plans budgétaires apparaîtront ici pour le suivi</p>
                </div>
            @endif
        </div>
    </div>
