...
<div class="budget-header">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1><i class="fas fa-plus-circle me-3"></i>Modification d'un Plan Budgétaire</h1>
...
<div class="container">
    <div class="form-container">
        <form action="{{ route('budget-plans.update', $budgetPlan) }}" method="POST" id="updateBudgetForm">
            @csrf
            @method('PUT')
            ...
            <div class="form-card">
                <div class="form-section">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="{{ old('name') ?? $budgetPlan->name }}"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="year-input-container">
                                <input type="number" name="year" id="year" class="form-control" min="2020"
                                    max="2030" value="{{ old('year') ?? $budgetPlan->year }}" required>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" name="conversion_xof" id="conversion_xof" class="form-control"
                                value="{{ old('conversion_xof') ?? $budgetPlan->conversion_xof }}"
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control"
                            placeholder="Décrivez les objectifs et le contexte de ce plan budgétaire...">
                        {{ old('description') ?? $budgetPlan->description }}
                        </textarea>
                        <div class="form-text">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn-submit">
                        <i class="fas fa-check me-2"></i>Modifier le Plan
                    </button>
                </div>
            </div>
        </form>
