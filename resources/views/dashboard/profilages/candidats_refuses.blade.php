        ...
        <div class="bg-white p-4 rounded-3 shadow-none mb-4">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-1 text-dark">Candidatures reversées au BARM</h5>
                        <small class="text-muted">Gestion des candidats non profilés / profilés reversés au BARM</small>
                    </div>
                </div>
                <div class="d-flex align-items-center gap-3">
                    <a href="{{ route('export.pdf.candidats_refuses') }}" class="btn btn-danger btn-sm text-white shadow-sm">
