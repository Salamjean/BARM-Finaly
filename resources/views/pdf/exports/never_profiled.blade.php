    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 25%;">Partenaire affecté</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($items as $index => $candidat)
                <tr>
                    ...
                    <td>{{ $candidat->partnerTechnical->user->username ?? 'Non assigné' }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="5" style="text-align: center;">Aucun candidat jamais profilé trouvé</td>
                </tr>
            @endforelse
        </tbody>
    </table>
